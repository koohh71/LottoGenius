            ...
            <div className="space-y-6 animate-fade-in text-gray-700">
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
                    <h3 className="font-bold text-gray-800 text-sm flex items-center gap-2">
                        <Hash size={16} className="text-blue-500"/> 번호 조합하기
                    </h3>
                    <ul className="space-y-2 text-xs">
                        <li className="flex gap-2">
                            <CheckCircle2 size={14} className="text-blue-500 shrink-0"/>
                            <span>
                                <strong>포함(고정수):</strong> 이 번호는 무조건 넣고 싶을 때 선택하세요. (파란색)
                            </span>
                        </li>
                        <li className="flex gap-2">
                            <X size={14} className="text-red-500 shrink-0"/>
                            <span>
                                <strong>제외수:</strong> 이 번호는 절대 안 나올 것 같을 때 선택하세요. (회색 취소선)
                            </span>
                        </li>
                        <li className="flex gap-2">
                            <RotateCcw size={14} className="text-gray-400 shrink-0"/>
                            <span>
                                <strong>초기화:</strong> 선택한 모든 설정을 지우고 처음부터 다시 시작합니다.
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm space-y-3">
                    <h3 className="font-bold text-gray-800 text-sm flex items-center gap-2">
                        <PlusCircle size={16} className="text-orange-500"/> 데이터 업데이트
                    </h3>
                    <p className="text-xs text-gray-600 leading-relaxed">
                        상단의 <strong>[+]</strong> 버튼을 눌러 최신 회차 정보를 직접 등록할 수 있습니다. 
                        입력된 정보는 즉시 분석 데이터에 반영되어 다음 번호 생성 시 활용됩니다.
                    </p>
                    <div className="bg-orange-50 text-orange-700 text-[10px] p-2 rounded font-medium flex gap-2 items-center">
                        <AlertCircle size={12}/>
                        <span>매주 토요일 추첨 후 정보를 업데이트 해주세요!</span>
                    </div>
                </div>
